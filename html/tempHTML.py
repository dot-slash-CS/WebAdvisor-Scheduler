...
# We need to separate template into sections (i.e. top section and bottom section)
# The break will allow for us to put in other stuff such as the container code depending on what is passed through to the function
# Most likely since the parameter that is passed is a list of schedules (scheules are a list of courses), we will have to iterate through each schedule and in that iteration iterate through each course


# template = '''
# <!DOCTYPE html>
# <!-- saved from url=(0034)https://uisapppr3.njit.edu/scbldr/ -->
# <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" class="dj_webkit dj_chrome dj_contentbox"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
...
# 		<title>Ohlone College: Schedule Builder</title>
		

# 		<link rel="stylesheet" href="./OhloneScheduleBuilder/claro.css">
# 		<!--<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/dojo/1.6/dijit/themes/claro/claro.css"/>-->
# 		<link rel="stylesheet" href="./OhloneScheduleBuilder/jquery-ui.css">
# 		<!--<link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.3/themes/smoothness/jquery-ui.css"/>-->

# 		<link rel="stylesheet" href="./OhloneScheduleBuilder/main.css">
# 		<link rel="stylesheet" href="./OhloneScheduleBuilder/print.css" media="print">
# 		<link rel="stylesheet" href="./OhloneScheduleBuilder/scheduleGrid.css">
# 		<!--[if IE 7]>
...
# 		<script src="./OhloneScheduleBuilder/jquery.js.download"></script>
...
# 				<script src="./OhloneScheduleBuilder/require-2.0.6.js.download"></script>
# 		<script>
...
# 				setTerm(result.term);
# 			}});
# 		</script><script type="text/javascript" charset="utf-8" async="" data-requirecontext="_" data-requiremodule="include/datasvc.php?p=/" src="./OhloneScheduleBuilder/datasvc.php"></script>
# 		<script defer="">
# 			_gaq = [];
# 		</script>

# 		<script src="./OhloneScheduleBuilder/json2.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/dojo.js.download" defer=""></script>
# 		<!--<script src="//ajax.googleapis.com/ajax/libs/dojo/1.10.3/dojo/dojo.js" data-dojo-config="async: true" defer></script>-->
# 		<script src="./OhloneScheduleBuilder/scbldr.dojo.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/jquery-ui.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/raphael.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/toolbox.expose.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/tools.overlay.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/tools.tooltip.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/underscore-1.3.3.js.download" defer=""></script>

# 		<script src="./OhloneScheduleBuilder/compat.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/autocomplete.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/messageport.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/worker.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/simplerpc.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/graph.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/timegrid.js.download" defer=""></script>
# 		<script src="./OhloneScheduleBuilder/site.js.download" defer=""></script>
# 	</head>
# 	<body class="claro">
# 		<noscript>
...
# 			}});
# 		</script>
# 		<div id="page" style="width: 1272px;">
# 			<div id="header" style="height: 45px;">
# 				<a href="http://www.ohlone.edu/" target="_blank" style="float: left;">
# 					<img src="./OhloneScheduleBuilder/ohlonelogo.jpg" alt="New Jersey Institute of Technology" width="170" height="45" id="njitlogo">
# 				</a>
# 				<h1 style="float: left; margin-left: 40px;"><a href="https://uisapppr3.njit.edu/scbldr/">Schedule Builder</a></h1>
# 				<nav style="/*float: right;*/ margin-top: 25px;">
# 					&nbsp;|&nbsp; <a id="infolink" href="https://uisapppr3.njit.edu/scbldr/#">info</a>
# 				</nav>
# 			</div>
# 			<div id="content">
# 				<div class="center" style="width: 874.4px;">
...
# 									<div>
# 										<span id="schedTitle" style="font-weight: 700; font-size: 1.5em; padding-right: 10px;">Spring 2017</span>
...
# 											<button type="button" id="printButton" onclick="_gaq.push([&#39;_trackEvent&#39;,&#39;print&#39;])" title="Better printing support (does not include non-meeting courses). No support for any version of IE." class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-print"></span><span class="ui-button-text">Print</span></button>
# 											<button type="button" id="clearButton" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" role="button"><span class="ui-button-icon-primary ui-icon ui-icon-trash"></span><span class="ui-button-text">Clear</span></button>
# 										</div>
# 									</div>
# 								</td>
# 							</tr>
...
# 								</table>
# 							</div>
# 							<div class="sv-grid" style="width: 822px;">
...
# 						<input type="text" class="ui-autocomplete-input empty" name="search" id="search_input" value="Add course" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true">
# 					</div>
# 					<hr>
# 					<span style="color: red">Note: Sections in red are full.</span>
# 					<hr>
# 					<div class="sec-view2 course-list dijitAccordionContainer dijitContainer dijitLayoutContainer" id="course_list" role="tablist" widgetid="course_list" style="overflow: hidden; height: 586px;"></div>
# 				<ul class="ui-autocomplete ui-menu ui-widget ui-widget-content" role="listbox" aria-activedescendant="ui-active-menuitem" style="z-index: 1; top: 0px; left: 0px; display: none;" aria-disabled="false"></ul></div>
# 				<div id="fade" style="display: none;"></div>
# 				<div id="load" style="display: none;">
# 					<!--<strong>Loading...</strong>-->
# 					<br>
# 					<img id="loader" src="./OhloneScheduleBuilder/spinner.gif">
# 				</div>
# 			</div>
...
# 								<img src="./OhloneScheduleBuilder/facebook.gif" width="15" height="16" alt="Facebook">
# 							</a>
# 						</li>
# 						<li>
# 							<a href="http://twitter.com/njit" target="_blank" title="NJIT on Twitter">
# 								<img src="./OhloneScheduleBuilder/twitter.gif" width="15" height="16" alt="Twitter">
# 							</a>
# 						</li>
# 						<li>
# 							<a href="http://youtube.com/njit" target="_blank" title="NJIT on YouTube">
# 								<img src="./OhloneScheduleBuilder/youtube.gif" width="15" height="16" alt="YouTube">
# 							</a>
# 						</li>
# 						<li>
# 							<a href="http://www.flickr.com/photos/njit" target="_blank" title="NJIT on Flickr">
# 								<img src="./OhloneScheduleBuilder/flickr.gif" width="15" height="16" alt="Flickr">
# 							</a>
# 						</li>
# 					</ul>
# 				</div>
...
# 		</div>
# 		<div id="infopanel">
# 			<iframe src="./OhloneScheduleBuilder/overview.html" style="border: none; padding: 0; margin: 0; width: 100%; height: 500px; padding-top: 30px;"></iframe>
# 		</div>
...
# <div><div id="removeAd" style="position:fixed;width:100%;height:100%;background-color:#00006C;z-index: 99999999999999999999;display:none;top:0;left:0;opacity:0.99;"><iframe src="./OhloneScheduleBuilder/saved_resource.html" style="width:0;height:0;display:none;"></iframe></div></div></body></html>
# '''