...
query_2 = {'term': '2017FA', 'subject': 'ENGL', 'course_number': '', 'section': ''}
...
query_2 = {'term': '2017FA', 'subject': 'MATH', 'course_number': '', 'section': ''}
engl1 = scraper.scrape_courses(debug=True, **query_2)
print(len(engl1))

query_2 = {'term': '2017SP', 'subject': 'MATH', 'course_number': '', 'section': ''}
engl1 = scraper.scrape_courses(debug=True, **query_2)
print(len(engl1))
